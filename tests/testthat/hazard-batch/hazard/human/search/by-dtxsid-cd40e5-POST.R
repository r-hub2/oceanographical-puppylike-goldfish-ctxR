structure(list(url = "https://api-ccte.epa.gov/hazard/human/search/by-dtxsid/", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        date = "Wed, 27 Mar 2024 21:30:35 GMT", `x-vcap-request-id` = "13d923ef-8350-4108-69ea-def04d14422d", 
        ...
        `x-amz-cf-pop` = "ATL59-P8", `x-amz-cf-id` = "397XSgWPj7KJTFXgViPLzf5lsQdVKTNsh-dhBSwp1sdx4vKfdJHcRw=="), class = c("insensitive", 
    ...
    date = structure(1711575035, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 4.5e-05, 
    connect = 0, pretransfer = 0.00019, starttransfer = 0.096922, 
    total = 0.09695)), class = "response")
